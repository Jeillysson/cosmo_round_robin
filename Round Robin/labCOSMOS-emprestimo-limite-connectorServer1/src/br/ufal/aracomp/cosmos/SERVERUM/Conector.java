...
public class Conector extends UnicastRemoteObject implements ConectorServerUmInterface{
	...
	public static void main (String args[]){
		try { 
            ...
            Naming.rebind("//localhost:2020/Conector",new Conector());
            System.err.println("Servidor 1 Prepadado");
